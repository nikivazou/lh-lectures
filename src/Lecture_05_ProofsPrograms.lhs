...
<p> _Anything that the SMT knows, for example boolean or linear logic:_</p>
...
Instrinsic theorems are the theorems that are part of the type signature of the function.
